        ...
        content
            ...
            .gesture(DragGesture(minimumDistance: 0.0)
                ...
                .onEnded { value in
                    ...
                    appModel.savedSphereBaseYaw = yaw
                    appModel.savedSphereBasePitch = pitch
                }
            )
            ...
            .onAppear {
                yaw = appModel.savedSphereYaw
                pitch = appModel.savedSpherePitch
            }
    }
