...
enum TransmitterMode: Int, CaseIterable {
    case receiver
    case transmitter
}
...
final class MultipeerConnection: NSObject, MultipeerProtocol {
    ...
    init(modes: [TransmitterMode] = TransmitterMode.allCases, configuration: MultipeerConfiguration) {
        ...
        browser = MCNearbyServiceBrowser(peer: me, serviceType: configuration.serviceType)
        advertiser = MCNearbyServiceAdvertiser(peer: me, discoveryInfo: nil, serviceType: configuration.serviceType)
